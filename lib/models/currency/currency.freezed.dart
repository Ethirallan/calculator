...
abstract class $CurrencyCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String label, int code});
}
...
class _$_Currency extends _Currency with DiagnosticableTreeMixin {
  _$_Currency({required this.id, required this.label, required this.code})
      : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Currency(id: $id, label: $label, code: $code)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, label, code);
...
abstract class _Currency extends Currency {
  factory _Currency(
      ...
      required final int code}) = _$_Currency;
  _Currency._() : super._();
